...
export const CustomResizableImage = ImageResize.extend({
  ...
  renderHTML({ node, HTMLAttributes }) {
    ...
    if (caption) {
      ...
      //   ? `${numericWidth - paddingAdjustment}px`
      //   : widthValue;
      //
      ...
      content.push(['span', {
        ...
        style: `display: block; font-size: 11px; line-height: 18px; font-weight: 400; color: #7D7D7D; text-align: center; maxWidth: 100%; box-sizing: border-box; overflow-wrap: break-word;`
      }, caption]);
